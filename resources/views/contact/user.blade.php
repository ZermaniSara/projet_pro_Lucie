...
<div class="row backgrounding" id="box">
    <div class="container" id="contenu">
      <div class="row justify-content-center">
          <div class="col-md-8">
              <h3 id="titre"> {{__('Welcome to the sending messages area')}}  </h3>
                  <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <label for="message" class="col-md-4 col-form-label text-md-right">{{ __('Messages*') }}</label>

                  <div class="col-md-6">
                      <textarea name="message" type="text" class="form-control" id="message" rows="5" required="required" ></textarea>
